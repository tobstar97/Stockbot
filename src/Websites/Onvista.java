 ...
 * @version 2019-01-04
 * @description Fetcht Bilanzdaten einer Aktie von Onvista und ruft Datenbank-Operation-Funktion auf.
 */
public class Onvista {

    private static boolean debug = true;
    private static boolean fullData = false;
     ...
     * @param fullData sollen DB-Einträge nur gemacht werden, wenn volle Datensätze für das jeweilige Jahr vorhanden sind?
     */
    public Onvista(Connection connection, boolean fullData) {
     ...
     * @param connection SQLConnection
     */
    public Onvista(Connection connection) {
        this.conn = connection;
    }
     ...
     * @param fullData sollen DB-Einträge nur gemacht werden, wenn volle Datensätze für das jeweilige Jahr vorhanden sind?
     */
    public Onvista(boolean fullData) {
        this.fullData = fullData;
    }

    /**
     * Konstruktor, baut selbst Datenbankverbindung
     */
    public Onvista() {
        try {
                ...
                if(fullData) {
                    if (!(year.equals("-") || umsatz.equals("-") || ekap.equals("-") || gkap.equals("-") || ebit.equals("-") || jue.equals("-"))) {
                        ...
                        if (InetAddress.getLocalHost().toString().contains("Andreas-PC")) {
                            ...
                            try {
                                ...
                                System.err.println(this.getClass().getName() + ": catchBilanzData: Z.279: " + e.getMessage() + " | " + e.getCause());
                            }
                        } else System.out.println(this.getClass().getName() + ": Z.281: Hier könnte ein Insert-Befehl stehen.");
                    } else if(debug) System.out.println(this.getClass().getName() + ": Jahr(" + year + "): no full data set available");
                } else {
                    if(umsatz.equals("-")) umsatz = null;
                    if(ekap.equals("-")) ekap = null;
                    if(gkap.equals("-")) gkap = null;
                    ...
                    if(InetAddress.getLocalHost().toString().contains("Andreas-PC")) {
                        ...
                        try {
                            ...
                            System.err.println(this.getClass().getName() + ": catchBilanzData: Z.294: " + e.getMessage() + " | " + e.getCause());
                        }
                    }
                }
            }
