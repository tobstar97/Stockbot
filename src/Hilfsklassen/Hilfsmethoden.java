...
//    === === === === === === === === === === = Alles Rund Um Die Zeit == === === === === === === === === === ===
     ...
     *
     * -Internetverbindung zu ermitteln ist schwierig und von Rechner zu Rechner unterschiedlich
     * -also eine stabile Internetseite aufrufen: google.com
     * @author Lukas Meinzer
     */
    public static void inetconnection(){
        try {
            java.net.InetAddress.getByName("google.com");
            System.out.println("Du hast Internet");
        } catch(java.net.UnknownHostException e) {
            System.out.println("Du hast leider kein Internet");
            System.exit(0);
        }
    }
